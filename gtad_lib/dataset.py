...
class VideoDataSet(data.Dataset):  # thumos
    ...
    def _get_data(self):
        if 'train' in self.subset:
            ...
            anno_df = pd.read_csv('/content/gdrive/MyDrive/gtad-master/data/thumos_annotations/val_Annotation.csv')
            print("hhh")
        ...
        self.flow_val = h5py.File('/content/gdrive/MyDrive/gtad-master/data/thumos_feature/TSN_pretrain_avepool_allfrms_hdf5/flow_val.h5', 'r')
        self.rgb_val = h5py.File('/content/gdrive/MyDrive/gtad-master/data/thumos_feature/TSN_pretrain_avepool_allfrms_hdf5/rgb_val.h5', 'r')
        self.flow_test = h5py.File('/content/gdrive/MyDrive/gtad-master/data/thumos_feature/TSN_pretrain_avepool_allfrms_hdf5/flow_test.h5', 'r')
        self.rgb_test = h5py.File('/content/gdrive/MyDrive/gtad-master/data/thumos_feature/TSN_pretrain_avepool_allfrms_hdf5/rgb_test.h5', 'r')
