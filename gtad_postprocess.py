...
thumos_class = {
    ...
    32: 'FistPump',
    33: 'ClapHands',
    34: 'OneRaisedArmCelebrate',
    35: 'TwoRaisedArmCelebrate',
    36: 'Throw',
    37: 'Drop',
    38: 'OneHandedCatch',
    39: 'TwoHandedCatch',
    ...
    52: 'VolleyballBlock',
    53: 'VolleyballServe',
    54: 'WeightliftingClean',
    55: 'WeightliftingJerk',
    56: 'HammerThrowWindUp',
    57: 'HammerThrowSpin',
    58: 'HammerThrowRelease',
    59: 'PoleVaultPlantPole',
    60: 'ShotPutBend',
    61: 'DiscusWindUp',
    62: 'DiscusRelease',
    63: 'TalkToCamera',
    64: 'CloseUpTalkToCamera',
    65: 'NoHuman',
}
...
def _gen_detection_video(video_name, video_cls, thu_label_id, opt, num_prop=200, topk = 10):
...
if __name__ == '__main__':
    ...
    for (tiou, mAP) in zip(tious, mAPs):
        print("mAP at tIoU {} is {}".format(tiou, 10*mAP))
